...
export default {
  ...
  methods: {
     ...
     */
    initData() {
      this.selectCondition.price = "";
      this.selectCondition.distance = "";
      this.selectCondition.category = "";
    }
  }
};
</script>
